...
(async () => {
  ...
  await page.evaluate((baseDir, profileImageData) => {
    ...
    const isRegularLayout = !document.querySelector('.pdf-cv-layout');
...
<body>
    <div class="cv-container">
      ...
      console.log('✅ PDF-optimized CV layout generated');
    } else {
      console.log('✅ PDF-specific layout detected, applying final optimizations...');
      
      // Apply minimal optimizations for PDF-specific layout
