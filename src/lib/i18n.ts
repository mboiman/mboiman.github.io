...
export const i18n: Record<'de' | 'en', I18nStrings> = {
  de: {
    ...
    agentWidget: {
      ...
      privacyNote: 'Das Gespräch wird protokolliert, um Anfragen zu bearbeiten und den Agenten zu verbessern.',
  ...
  en: {
    ...
    agentWidget: {
      ...
      privacyNote: 'The conversation is logged to process requests and improve the agent.',
