...
export const i18n: Record<'de' | 'en', I18nStrings> = {
  de: {
    ...
    facts: [
      ...
      { label: 'Abrechnung', value: 'eigene Rechnung oder BKS-Lab' },
    ...
    storyClosingEyebrow: 'BKS-Lab · Frankfurt am Main',
  ...
  en: {
    ...
    facts: [
      ...
      { label: 'Billing', value: 'own account or BKS-Lab' },
