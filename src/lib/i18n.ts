...
export const i18n: Record<'de' | 'en', I18nStrings> = {
  de: {
    ...
    agentWidget: {
      ...
      privacyNote: 'Ihre Nachrichten werden gespeichert, um Anfragen zu bearbeiten und den Agenten zu verbessern.',
  ...
  en: {
    ...
    agentWidget: {
      ...
      privacyNote: 'Conversations are stored to process requests and improve the agent.',
